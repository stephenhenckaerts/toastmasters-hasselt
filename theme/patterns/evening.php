...
<div class="wp-block-group tmh-first" style="margin-bottom:var(--wp--preset--spacing--40)">
<!-- wp:heading {"level":3,"className":"tmh-first__title"} -->
<h3 class="wp-block-heading tmh-first__title">Je eerste avond, van binnenkomen tot naar huis</h3>
<!-- /wp:heading -->

<!-- wp:html -->
<dl class="tmh-first__list">
	<div class="tmh-first__row">
		<dt>Wanneer je toekomt</dt>
	...
	<div class="tmh-first__row">
		...
		<dd>Tien tot twintig leden. Groot genoeg voor een echt publiek, klein genoeg om iedereen te leren kennen.</dd>
	</div>
	<div class="tmh-first__row">
		<dt>Wat mensen aanhebben</dt>
		<dd>Gewone, alledaagse kleren. Geen pak, geen dresscode.</dd>
	</div>
	<div class="tmh-first__row">
		<dt>Wat je moet doen</dt>
		<dd>Niets. Je luistert. Niemand vraagt je iets voor de groep, tenzij je het zelf wil.</dd>
	</div>
	<div class="tmh-first__row">
		<dt>Hoe het eindigt</dt>
		<dd>Om 22:00 is het gedaan. Wie wil, praat daarna nog wat na. Je mag ook gewoon vertrekken.</dd>
	</div>
</dl>
<!-- /wp:html -->
</div>
...
<figure class="wp-block-image tmh-photo tmh-photo--sticky"><img src="<?php echo $tmh_img; ?>" alt="Een spreker oefent buiten op de Corda Campus terwijl een kleine groep leden op de trappen toekijkt." width="1000" height="1333" loading="lazy" decoding="async"/></figure>
<!-- /wp:image -->
</div>
<!-- /wp:column -->
</div>
